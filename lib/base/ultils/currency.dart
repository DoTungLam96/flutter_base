...
class Currency {
  ...
  String vndToTextVI({number, seperator = ''}) {
    try {
  ...
  String vndToTextEN(int num) {
    final convertValue = NumberToWordsEnglish.convert(num);
    return convertValue.substring(0, 1).toUpperCase() +
        convertValue.substring(1);
  }
}
